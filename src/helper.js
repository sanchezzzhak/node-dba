...
export function merge(param1, param2) {
...
export function replaceCallback(pattern, callback, string) {
 ...
 * @returns {boolean}
 */
export function instanceOf(obj, right) {
...
export function strncmp(str, search, pos) {
 ...
 * @returns {*}
 */
export function compareArrayExist(a, b) {
 ...
 * @returns {*}
 */
export function compareArrayNotExist(a, b) {
	return a.filter((n) => b.indexOf(n) === -1);
}
 ...
 * @returns {*}
 */
export function arrayUnique(arr1) {
